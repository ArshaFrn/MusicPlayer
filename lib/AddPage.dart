...
class _AddPage extends State<AddPage> {
                    ...
                    child: _publicMusics.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final isAlreadyAdded = widget._user.tracks.any((m) => m.id == music.id);
                              ...
                              return Card(
                                ...
                                child: ListTile(
                                  leading: Container(
                                    ...
                                    child: music.coverImagePath != null && music.coverImagePath!.isNotEmpty
                                        ? ClipRRect(
                                            borderRadius: BorderRadius.circular(8),
                                            child: Image.file(
                                  ...
                                  trailing: isAlreadyAdded
                                      ...
                                      : IconButton(
                                          ...
                                          onPressed: () => _addPublicMusicToLibrary(music),
                                        ),
                                ),
                              );
                            },
  ...
  Future<bool?> _showPublicPrivateDialog(BuildContext context, Music music) async {
  ...
  Future<void> _addPublicMusicToLibrary(Music music) async {
    try {
      final tcpClient = TcpClient(serverAddress: '10.0.2.2', serverPort: 12345);
      final response = await tcpClient.addMusicToLibrary(widget._user.username, music);
